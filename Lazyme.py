from sklearn.metrics import r2_score,accuracy_score,mean_squared_error,mean_absolute_error,classification_report,confusion_matrix,precision_score,recall_score,roc_curve,auc
...
from sklearn.ensemble import ExtraTreesClassifier,RandomForestClassifier,RandomForestRegressor,ExtraTreesRegressor,GradientBoostingRegressor,VotingRegressor
...
name=[pacc,dc,rfc,exc,logreg,rc,knn,svc,gbc]
name_r=[pacr,gbr,dtr,rfr,ext,las,knnr,linereg,svr]
...
class smart_classifier:
    ...
    def cross_validation(self):
        ...
        for i in name:
            i.fit(trainx,trainy)
            score=cross_val_score(i,self.__x,self.__y,cv=10)
    ...
    def precision_score(self):
        ...
        if (trainy.nunique())>2: # Multiclass
            ...
            for i in name:
                ...
                pred=i.predict(testx)
                print('{}    :'.format(i),precision_score(testy,pred))
                print()
    ...
    def recall_score(self):
        ...
        if (trainy.nunique())>2: # Multiclass
            ...
            for i in name:
                i.fit(trainx,trainy) # Binary
                pred=i.predict(testx)
                print('{}    :'.format(i),recall_score(testy,pred))
                print()
